...
library(gifski)
png_files <- list.files(path = "./fishing/Future Prediction/Figures/BOTH YEARS/2019/",full.names = TRUE)
...
gifski::gifski(sorted_files, gif_file = "./fishing/Future Prediction/Figures/2019BOTHprobability.gif",delay = 0.2,height = 1080,width = 1920)
